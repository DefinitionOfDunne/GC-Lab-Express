...
app.get('/random', function (req, res) {
    var collection = [
        ...
        {
            quote: "In the happy land of elegant code and pretty rainbows, there lives a spoil-sport monster called inefficiency.",
            author: "Marijn Haverbeke", 
            image: "images/haverbeke.jpg"
        }
